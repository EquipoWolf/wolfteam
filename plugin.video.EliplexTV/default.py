...
SOURCES = [{"title": "EliplexTV ", "url": "https://dl.dropboxusercontent.com/s/7czjgsz0muedxsi/Eliplex.Principal.xml", "fanart": "https://i.imgur.com/rdVQTRt.jpg", "genre": "TV ONLINE", "date": "10.31.2015", "credits": "EliplexTV", "thumbnail": "https://i.imgur.com/HJqbI7D.png"}]

# https://i.imgur.com/rdVQTRt.jpg
# https://i.imgur.com/HJqbI7D.png
...
#            ln+='</item>'
    ...
    if not (keyboard.isConfirmed() == False):
        ...
        if newStr==parentalblockedpin:
            ...
            xbmc.executebuiltin("XBMC.Notification(EliplexTV,Parental Block Disabled,5000,"+icon+")")
        else:
            xbmc.executebuiltin("XBMC.Notification(EliplexTV,Wrong Pin??,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
elif mode==56:
    addon_log("disable lock")
    addon.setSetting('parentalblocked', "true")
    xbmc.executebuiltin("XBMC.Notification(EliplexTV,Parental block enabled,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
