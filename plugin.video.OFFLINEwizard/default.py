...
base='http://www.OFFLINE.com'
ADDON=xbmcaddon.Addon(id='plugin.video.OFFLINEwizard')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/mIPbn4Hpav67X6Gv/wolf.txt?download=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("OFFLINE Wizard","Downloading ",'', 'Please Wait')
