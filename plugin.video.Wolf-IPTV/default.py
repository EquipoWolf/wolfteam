...
SOURCES = [{"title": "Wolf-IPTV", "url": "https://googledrive.com/host/0BzqtJBUy3FRTaTNZdVRndEt2MXM", "fanart": "https://copy.com/1uRUH7snPMDICZvw","thumbnail": "https://copy.com/KR9YJLG0PJQm7nLc"}]

# https://copy.com/1uRUH7snPMDICZvw
# https://copy.com/KR9YJLG0PJQm7nLc
...
def getSources():
        if os.path.exists(favorites) == True:
            ...
            if FAV == "[]":
                ...
                addDir('[COLOR red][B]- FAVORITES CHANNEL Wolf-IPTV [/COLOR][/B]','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'','','','')
                addDir('','',100,'',FANART,'','','','')
