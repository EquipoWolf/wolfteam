...
SOURCES = [{"url": "https://bit.ly/yulfiostvxml", "fanart": "http://i.imgur.com/aOyKUFn.jpg", "genre": "Tv Live", "date": "10.07.2015", "credits": "Yulfiostv", "thumbnail": "http://i.imgur.com/CUE62qD.png"}]
...
def search(site_name,search_term=None):
    ...
    if 'youtube' in site_name:
        ...
        if res == 'True':
            ...
            xbmc.executebuiltin("XBMC.Notification(Yulfiostv-TV,No IMDB match found ,7000,"+icon+")")
